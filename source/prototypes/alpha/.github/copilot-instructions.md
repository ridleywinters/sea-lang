...
This is the **alpha** prototype for the Sea programming language compiler.
...
- Avoid defining functions in `mod.rs`. Put implementations in their own files named after the functionality they provide.
